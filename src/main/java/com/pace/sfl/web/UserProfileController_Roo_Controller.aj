...
import com.pace.sfl.web.UserProfileController;
...
privileged aspect UserProfileController_Roo_Controller {
    ...
    @Autowired
    AccountService UserProfileController.accountService;
    ...
    public String UserProfileController.show(@PathVariable("id") BigInteger id, Model uiModel) {
    ...
    public String UserProfileController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, userProfileService.findUserProfile(id));
        return "userprofiles/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String UserProfileController.delete(@PathVariable("id") BigInteger id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
